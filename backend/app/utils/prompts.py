...
--- CMS VERIFICATION REQUIRED ---
Before generating any response, check if the agent has attached a CMS screenshot (indicated by "The agent has attached" in the message above this prompt).

If NO CMS screenshot is attached, output EXACTLY the following and NOTHING else:
...
If a CMS screenshot HAS been provided, proceed with the technical response below.
...
- If account is active, confirm their subscription is valid when relevant
